                            ...
                            <div class="col-sm-6">
                                <div class="contactinfo">
                                    <ul class="nav nav-pills">
                                        <li><a href="#"><i class="fa fa-phone"></i> +38 093 674 34 23</a></li>
                                        <li><a href="#"><i class="fa fa-envelope"></i> bilen.kr@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="shop-menu pull-right">
                                    <ul class="nav navbar-nav">
                                        <li><a href="/cart">
                                                ...
                                                (<span id="cart-count"><?php echo CartComponent::countItems(); ?></span>)
                                            </a>
                                        </li>
