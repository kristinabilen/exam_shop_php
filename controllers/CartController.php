...
class CartController
{
    ...
    public function actionAddAjax($id)
    {
        ...
        echo CartComponent::addProduct($id);
        return true;
    }
    ...
    public function actionDelete($id)
    {
        ...
        CartComponent::deleteProduct($id);
    ...
    public function actionIndex()
    {
        ...
        $productsInCart = CartComponent::getProducts();
        ...
        if ($productsInCart) {
            ...
            $products = ProductModel::getProdustsByIds($productsIds);

            // Получаем общую стоимость товаров
            $totalPrice = CartComponent::getTotalPrice($products);
        }
    ...
    public function actionCheckout()
    {
        ...
        // Количество товаров
        $totalQuantity = CartComponent::countItems();
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($errors == false) {
                ...
                $result = OrderModel::save($userName, $userPhone, $userComment, $userId, $productsInCart);
